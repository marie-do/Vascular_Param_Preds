...
class DGCNN(nn.Module):
    def __init__(self, input_dim=5, emb_dims=128, drop_prob1=0.1, drop_prob2=0.45, num_classes=4):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(2 * self.input_dim, 64, kernel_size=1, bias=False),
                                   self.bn1,
