...
train_dataset = VascularDataset(data_root=folder_path, category='aorta', point_number=512, num_points_skel=128, split='train', random_flip=True, random_jitter=True, random_scale=True, center_shift=True,normalize_coord=True, random_shift=True)
